...
then
	...
	v4l2-ctl -d$CAMERA_L --set-ctrl white_balance_temperature_auto=1
	v4l2-ctl -d$CAMERA_L --set-ctrl exposure_auto=3
	v4l2-ctl -d$CAMERA_L --set-ctrl exposure_absolute=1
	v4l2-ctl -d$CAMERA_L --set-ctrl white_balance_temperature=4000
	v4l2-ctl -d$CAMERA_L --set-ctrl brightness=3
else
...
then
	...
	v4l2-ctl -d$CAMERA_R --set-ctrl white_balance_temperature_auto=1
	v4l2-ctl -d$CAMERA_R --set-ctrl exposure_auto=3
	v4l2-ctl -d$CAMERA_R --set-ctrl exposure_absolute=1
	v4l2-ctl -d$CAMERA_R --set-ctrl white_balance_temperature=4000
	v4l2-ctl -d$CAMERA_R --set-ctrl brightness=3
else
